...
;Function to check boundary of obstacle
;INPUTS - Current location
;OUTPUTS - True / False
...
;Function to check whether obstacle contouring completed or not
;INPUTS - First boundary hit location, Current location
;OUTPUTS - True / False
...
;Function to obstacle follow
;INPUTS - Start location
;OUTPUTS - Robot Motion
(defun obstacle-follow (start-location) (prog (contourcompleted firstboundaryhit firstboundaryhitloc currentloc maxiterations i sensors navigatecommand firstobstaclehit firstobstaclehitloc obstaclecompleted)
...
;Function to obstacle follow with (s2 s4 s6 s8) working properly
;INPUTS - Start location
;OUTPUTS - Robot Motion
(defun obstacle-follow-impaired-odd (start-location) (prog (contourcompleted firstboundaryhit firstboundaryhitloc currentloc maxiterations i sensors navigatecommand firstobstaclehit firstobstaclehitloc obstaclecompleted prev-command prev-sensors)
                                                       (setq firstboundaryhit nil)
                                                       (setq firstboundaryhitloc nil)
                                                       (setq firstobstaclehit nil)
                                                       (setq firstobstaclehitloc nil)
...
;Function to obstacle follow with (s1 s3 s5 s7) working properly
;INPUTS - Start location
;OUTPUTS - Robot Motion
(defun obstacle-follow-impaired-even (start-location) (prog (contourcompleted firstboundaryhit firstboundaryhitloc currentloc maxiterations i sensors navigatecommand firstobstaclehit firstobstaclehitloc obstaclecompleted prev-command prev-sensors)
                                                        (setq firstboundaryhit nil)
                                                        (setq firstboundaryhitloc nil)
                                                        (setq firstobstaclehit nil)
                                                        (setq firstobstaclehitloc nil)
